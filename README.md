...
Continue licenses and attribution.
...
External contribution intake is not open yet while project governance,
reporting channels, and contributor terms are established. Please do not open
an unsolicited pull request. See the
[contribution status](https://github.com/chadmzoghby-alt/please-continue/blob/main/CONTRIBUTING.md)
